...
#include "main.h"
#include "pins.hpp"
const uint32_t GPIOA_MODER_Minutes[] __attribute__ ((aligned (32))) = {
		0xFFFF5FFF, 0xFFFF7FFF, 0xFFFF7FFF, 0xFFFF77FF, 0xFFFFF7FF, 0xFFFFF7FF,
		0xFFFFD7FF, 0xFFFFFD7F, 0xFFFFFF5F, 0xFFFFFDDF, 0xFFFFFDDF, 0xFFFFFFD7,
		0xFFFFFDF7, 0xFFFFFDF7, 0xFFFFFF77, 0xFF7FFFFF, 0x7F7FFFFF, 0x7FFFFFFF,
		0x7FFFFFFF, 0x7DFFFFFF, 0xFDFFFFFF, 0xFDFFFFFF, 0xFFDDFFFF, 0xFFF5FFFF,
		0xFFD7FFFF, 0xFFD7FFFF, 0xFFF7FFFF, 0xFFFFDFFF, 0xFFFFDFFF, };
const uint32_t GPIOB_MODER_Minutes[] __attribute__ ((aligned (32))) = {
		0xFFFFFFFF, 0xFFFFFFFD, 0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFD, 0xFFFFFFFD,
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFF7FFF, 0xFFFFFFFF, 0xFFFF7FFF,
		0xFFFF7FFF, 0xFFFFFFFF, 0xFFFF7FFF, 0xFFFF7FFF, 0xFFFFFFFF, 0xFFFFFFFF,
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFF7, 0xFFFFFFFD, 0xFFFFFFFD, };
const uint32_t GPIOA_MODER_Hours[] __attribute__ ((aligned (32)))
		= { 0xFFFF5FFF, 0xFFFF77FF, 0xFFFFD7FF, 0xFFFFFF5F, 0xFFFFFFD7,
				0xFFFFFF77, 0x7F7FFFFF, 0x7DFFFFFF, 0xFD7FFFFF, 0xFFF5FFFF,
				0xFFF7FFFF, 0xFFFDFFFF, };
const uint32_t GPIOB_MODER_Hours[] __attribute__ ((aligned (32)))
		= { 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
				0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
				0xFFFFFFF7, 0xFFFFFFF7, };
const uint16_t GPIOA_ODR_Minutes[] __attribute__ ((aligned (16))) = { 0x40, 0x0,
		0x80, 0x80, 0x20, 0x0, 0x20, 0x8, 0x8, 0x10, 0x4, 0x4, 0x2, 0x10, 0x2,
		0x800, 0x800, 0x0, 0x8000, 0x8000, 0x1000, 0x0, 0x100, 0x100, 0x400,
		0x200, 0x200, 0x0, 0x40, };
const uint16_t GPIOB_ODR_Minutes[] __attribute__ ((aligned (16))) = { 0x0, 0x1,
		0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		0x0, 0x80, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, };
const uint16_t GPIOA_ODR_Hours[] __attribute__ ((aligned (16))) = { 0x80, 0x20,
		0x40, 0x4, 0x2, 0x8, 0x8000, 0x1000, 0x800, 0x200, 0x0, 0x100, };
const uint16_t GPIOB_ODR_Hours[] __attribute__ ((aligned (16))) = { 0x0, 0x0,
